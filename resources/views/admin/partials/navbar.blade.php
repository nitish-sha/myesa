  ...
  <ul class="nav flex-column">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="productDropdown">
        <a class="dropdown-item" href="{{route('admin.product.create')}}">Add Blog</a>
        <a class="dropdown-item" href="{{route('admin.product.index')}}">All Blog</a>
        <a class="dropdown-item" href="{{route('admin.product.trash')}}">Trashed Blog</a>
      </div>
    </li>
    <li class="nav-item dropdown">
	...
	<li class="nav-item">
      <a class="nav-link @if(request()->url() == route('admin.postview')) {{'active'}} @endif" href="{{route('admin.postview')}}">
        <span data-feather="file"></span>
        Comment Listing
      </a>
    </li>
	<li class="nav-item">
      <a class="nav-link @if(request()->url() == route('admin.contact')) {{'active'}} @endif" href="{{route('admin.contact')}}">
        <span data-feather="file"></span>
        Contact Listing
      </a>
    </li>
